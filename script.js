...
////START DRAFT Surfboard Rentals API search
...
//DRAFT AJAX CALL OF GOOGLE PLACES API (SERVER-SIDE)
$(function sbRentalsSearch(){
  var sbRentalsSearchURL = `https://maps.googleapis.com/maps/api/place/textsearch/json?query=surfboard+rentals+santa+barbara+california&key=AIzaSyAXPJDWXhzlAY0N8mMUcgFJ6yNSEd0vMg8`;
  $.ajax({
    type: 'GET',
    url: `${sbRentalsSearchURL}`,
    success: function(response) {
      console.log('success', response);
    } //END sbRentalsSearch success function
  }); //End sbRentalsSearch AJAX call
}); //END sbRentalsSearch funciton


// `https://maps.googleapis.com/maps/api/place/textsearch/json?query=surfboard+rentals+santa+barbara+california&key=AIzaSyAXPJDWXhzlAY0N8mMUcgFJ6yNSEd0vMg8`;
//`https://maps.googleapis.com/maps/api/js?key=AIzaSyAXPJDWXhzlAY0N8mMUcgFJ6yNSEd0vMg8&libraries=places&query=surfboard+rentals+santa+barbara+california`;

////END DRAFT Surfboard Rentals API search
